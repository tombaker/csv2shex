...
def csvreader(csvfile):
    ...
    csvrow_dicts_list = _get_csvrows(csvfile)
...
def _get_csvshapes_list(csvrow_dicts_list=None):
    """Return list of CSVShape instances from list of CSV rows (as dicts)."""
    # /Users/tbaker/github/tombaker/csv2shex/tests/test_csvreader/test_get_csvshapes_list.py
