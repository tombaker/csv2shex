...
As defined in the DC Application Profile model (DCAP), a CSVRow is a property-value pair in the context of a Shape. An instance of the class :class:`csv2shex.csvrows.CSVRow`:
...
.. autoclass:: csv2shex.csvrows.CSVRow
    :members:
